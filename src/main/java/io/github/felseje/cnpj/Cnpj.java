...
/**
 * Represents a CNPJ (Cadastro Nacional da Pessoa Jurídica), which is the Brazilian national
 * registry of legal entities.
 *
 * <p> This class is responsible for storing, validating, and formatting CNPJ numbers. </p>
 * <p> A valid CNPJ consists of 18 characters formatted (e.g., "12.345.678/0001-95",
 * "12.ABC.345/01DE-35") or 14 characters unformatted (e.g., "12345678000195", "12ABC34501DE35").
 * </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
...
public class Cnpj {
   ...
   * @return {@code true} if the given object is also a {@code Cnpj} and all internal components
