 ...
 * <p>
 * This exception is typically used when a classifier or parser encounters a document that does not
 * match any known {@code CnpjType}.
 * </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
...
public class UnrecognizedCnpjTypeException extends RuntimeException {
  ...
  /**
   * Constructs a new {@code UnrecognizedCnpjTypeException} with the specified detail message and
   * cause.
   *
   * @param message the detail message explaining the reason for the exception
   * @param cause   the cause of this exception (which can be retrieved later by
   *                {@link #getCause()})
   */
