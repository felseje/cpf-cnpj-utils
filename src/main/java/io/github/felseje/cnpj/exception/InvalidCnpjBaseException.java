 ...
 *
 * <p> This exception signals that the provided CNPJ base does not meet the expected criteria such
 * as format, length, or content. </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
 */
public class InvalidCnpjBaseException extends InvalidDocumentBaseException {
  ...
  /**
   * Constructs a new {@link InvalidCnpjBaseException} with the specified detail message and cause.
   *
   * @param message the detail message explaining the reason for the exception.
