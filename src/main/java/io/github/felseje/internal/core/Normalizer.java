 ...
 * <p>
 * Implementations of this interface typically remove unwanted characters and standardize the format
 * of input data such as document identifiers.
 * </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
...
public interface Normalizer {
  ...
  /**
   * Removes non-essential characters from the given input string, such as punctuation, whitespace,
   ...
   * <p>
   * This may include trimming, converting to a uniform case, or applying formatting rules specific
