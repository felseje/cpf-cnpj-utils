 ...
 * <p>
 * Implementations of this interface should analyze the input document string and return the
 * corresponding {@code CnpjType} based on its content or structure.
 * </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
