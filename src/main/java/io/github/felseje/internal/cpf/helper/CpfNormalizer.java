 ...
 * }</pre>
 *
 * <p>This class does <strong>not</strong> validate check digits — only the structural integrity of
 * the input.</p>
 *
 * @author felseje
 * @since 1.0.0-alpha
...
public class CpfNormalizer implements Normalizer {
  ...
  public String clear(String input) throws IllegalArgumentException {
    StringUtils.requireNotBlank(input, "The CPF must not be null or blank");
