 ...
 *
 * <p> This exception typically signals that the input used to build a document (e.g., CPF or CNPJ)
 * does not meet the expected format, length, or digit requirements. </p>
 *
 * @author felseje
 * @since 1.0.0-alpha
 */
public class InvalidDocumentBaseException extends RuntimeException {
  ...
  /**
   * Constructs a new {@code InvalidDocumentBaseException} with the specified detail message and
   * cause.
   *
