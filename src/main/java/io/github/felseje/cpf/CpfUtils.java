 ...
 *
 * <p> Provides static methods for validating, formatting, normalizing, and generating CPF numbers,
 * following the standard Brazilian individual taxpayer identification format. </p>
 *
...
public final class CpfUtils {
  ...
  public static void validate(String cpf) throws IllegalArgumentException, InvalidCpfException {
    StringUtils.requireNotBlank(cpf, "The CPF cannot be null or blank");
